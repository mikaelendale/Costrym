export function WhyCostrymSection() {
    return (
        <section className="border-border px-4 py-20 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl text-center">
                <h2 className="mb-8 text-5xl font-bold">Why Costrym Exists</h2>

                <div className="space-y-6 text-left">
                    <p className="text-2xl leading-relaxed font-bold text-muted-foreground">
                    ...
                    <p className="mt-8 text-xl font-semibold text-foreground">Costrym changes that.</p>
