...
import { ArrowLeft, Shield, Clock, FileText, Mail, Phone, MapPin } from "lucide-react"
...
export default function RefundPolicy({ content, pageTitle, pageDescription, lastUpdated, pageType }: RefundPolicyProps) {
                    ...
                    <div className="container relative mx-auto px-4 py-20 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center"> 
                            ...
                            <p className="text-sm text-primary">
                                Our refund policy outlines the conditions under which you can request a refund for your purchase at Costrym
                            </p> 
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-background">
                    <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-4xl text-center">
                            ...
                            <Button onClick={() => router.get('/support')} className="" variant={'default'}>
                                Ask Here
                            </Button>
                        </div>
                    </div>
