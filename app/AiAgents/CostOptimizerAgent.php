 ...
 *
 * Master AI Cost Engineer that orchestrates root analysis, solution generation,
 * and cost impact simulation sub-agents.
 */
class CostOptimizerAgent extends Agent
{
