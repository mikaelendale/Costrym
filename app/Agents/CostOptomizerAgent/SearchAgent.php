...
class SearchAgent extends BaseLlmAgent
{
    ...
    protected string $description = 'Runs targeted web searches using SearchTool based on SolutionGenerator outputs to gather alternatives, pricing, and implementation insights.';
